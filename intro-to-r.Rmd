...
ggplot(plot_df, aes(x = LGBTQ, y = pr_vs_nonLGBT)) +
  ...
  labs(
    ...
    subtitle = "LGBTQ+ students compared to Heterosexual students",
    x = "",
...
ggplot(plot_df, aes(x = age, y = pr_vs_nonLGBT)) +
  ...
  labs(
    title = "Prevalence Ratio of Being Bullied at School",
    subtitle = "LGBTQ+ students compared to Heterosexual students, within each age group",
    x = "Age",
    y = "Prevalence Ratio (PR)"
  ) +
  theme_minimal() +
...
ggplot(plot_df, aes(x = reorder(race, pr_vs_nonLGBT), y = pr_vs_nonLGBT)) +
  ...
  labs(
    title = "Prevalence Ratio of Being Bullied at School",
    subtitle = "LGBTQ+ students compared to Heterosexual students, within each race group",
    x = "Race/Ethnicity",
    y = "Prevalence Ratio (PR)"
  ) +
  theme_minimal() +
