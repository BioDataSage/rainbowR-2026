...
Let's calculate and visualize these prevalence ratios, using heterosexual students as our reference group (PR = 1).
...
overall_prev <- yrbs_filter %>%
  ...
  mutate(
    pr_vs_nonLGBT = prevalence / prevalence[LGBTQ == "Heterosexual"]
  )
...
The dashed line at PR = 1 represents the reference group (Heterosexual students). Values above this line indicate higher prevalence of bullying compared to the reference group. We can see that LGBTQ+ students generally had a higher prevalence in bullying.
...
age_prev <- yrbs_filter %>%
  ...
  group_by(age) %>%
  mutate(
    prev_nonLGBT = prevalence[LGBTQ == "Heterosexual"],
...
-   In general, it looks like LGBTQ+ students experience higher rates of bullying compared to heterosexual students across all demographic groups
